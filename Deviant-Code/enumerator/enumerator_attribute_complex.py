...
def compute_support_complex_index_with_bitset__modfied__04012019(attributes,dataset,datasetIndices,datasetIndices_bitset,allIndexes,refinement_index,wholeDataset=[],threshold=0,closed=True):
	attr_ref=attributes[refinement_index]
